...
var (
	...
	driverName        = flag.String("drivername", "cryptpvc.zerocloud.io", "name of the driver")
...
func handle() {
	driver, err := cryptpvc.NewCryptpvcDriver(*driverName, *nodeID, *endpoint, *ephemeral, *maxVolumesPerNode, version)
	if err != nil {
